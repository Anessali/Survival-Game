	...
	// ======================
		...
		// Start of example static items.
			...
			Items.dagger = { 
				...
				plural : "daggers", 
				size : 2, 
				image : "icon_dagger3.png", 
				description : "A small dagger." 
			};

			Items["gold coin"] = { 
				type : ["money"], 
				singular : "a gold coin", 
				plural : "gold coins", 
				size : 0, 
				image : "coin.png", 
				description : "Gold coins are the standard currency." 
			};

			Items["heavy mace"] = { 
				type : ["weapon", "blunt", "2-handed"], 
				singular : "a heavy mace", 
				plural : "heavy maces", 
				size : 6, 
				image : "Heavy_Mace.png", 
				description : "A heavy mace with pointy flanges on it." 
			};
			...
			Items.pants = { 
				...
				place : ["hips2"], 
				size : 4, 
				image : "icon_cloth_pants1.png", 
				description : "A pair of pants." 
			};

			Items.shoes = { 
				type : ["clothing"], 
				singular : "a pair of shoes",
				 plural : "pairs of shoes", 
				 place : ["feet1"], 
				 size : 2, 
				 image : "icon_shoes.png", 
			...
			Items.shortsword = { 
				...
				plural : "short swords", 
				size : 4, 
				image : "icon_sword_short1.png", 
				description : "A shortsword." 
			};

			Items.suit = { 
				type : ["clothing", "container"], 
				UInvPocket : { pocket: "suit pocket" }, 
				singular : "a suit jacket", 
				plural : "suit jackets", 
				place : ["torso1"], 
				size : 5, 
				image : "suit.png", 
				description : "A classic black suit jacket with a pocket." 
			};  // This item is for an infinite loop test, since it will have a suit in each suit pocket.  Normally you should avoid such loops.
